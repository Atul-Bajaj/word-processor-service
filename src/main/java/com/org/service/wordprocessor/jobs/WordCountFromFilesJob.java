...
@Component
public class WordCountFromFilesJob implements Serializable {
    ...
    public Map<String, Long> executeJob(String path, ValidatorProcess process) {

        JavaRDD<String> essays = sc.textFile(path);
